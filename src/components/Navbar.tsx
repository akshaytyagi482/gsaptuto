...
const Navbar = () => {
  ...
  return (
    <div ref={omk} className=" fixed z-[999] w-full px-20 py-8 max-md:px-5 min-w-80 flex justify-between items-center">
        <div className="logo">
        ...
        <div className="link flex max-md:hidden items-center gap-10">
            {["Work with us","Our work","About us"].map((items,index)=>(
